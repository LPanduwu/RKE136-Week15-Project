...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=6771f08b56ee44459d32a05b624f9d2e`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=6771f08b56ee44459d32a05b624f9d2e&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=6771f08b56ee44459d32a05b624f9d2e`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
